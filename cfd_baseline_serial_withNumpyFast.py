...
# Version description: Baseline serial code. Uses Numpy fast array calculations.
...
if argument.p==str(1):
    ...
    args = ["velocityNUM.dat", "colourmapNUM.dat", "outNUM_sf" + str(scaleFactor) + "_r" + argument.r + "_i"+ str(iteration) +".png"]
    plot_flow.main(args)